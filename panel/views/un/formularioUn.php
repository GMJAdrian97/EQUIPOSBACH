            ...
            <div class="col">
                ...
                <form method="POST"
                    ...
                    <fieldset id="fieldset">
                        <h2 class="fs-title">
                            <?php echo(isset($id_un))? "Modifica a tu ": " Introduce tu nevo ";?>un</h2>
                        <br />
                        <div class="col-auto">
                            <label class="sr-only" for="inlineFormInputGroup">Un</label>
                            <div class="input-group mb-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="bi bi-journal-plus"></i></div>
                                </div>
                                <input type="text" name="nombre"
                                    value="<?php echo(isset($id_un)) ? $datosUn['nombre']:"";?>" class="form-control"
                                    id="inlineFormInputGroup" placeholder="un" />
                            </div>
                        </div>
                        <br />
                        <br />
