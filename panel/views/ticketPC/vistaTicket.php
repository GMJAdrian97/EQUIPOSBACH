            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <a
                                href="ctrlTicketPC.php?accion=modify&id_ticket=<?php echo $datosTicketPC['id_ticket']; ?>"><button
                            ...
                            <a
                                href="ctrlTicketPC.php?accion=modify&id_ticket=<?php echo $datosTicketPC['id_ticket']; ?>"><i class="bi bi-info-circle"></i></a>
                        </div>
                    </td>
