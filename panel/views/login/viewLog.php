<?php require_once('../../../componentes/headerB.php');?>
<div class="session">
    <div class="left">
    </div>
    <form method="POST" action="ctrlLogin.php?accion=login" class="log-in" autocomplete="off">
    <img src="/EQUIPOSBACH/img/logo.png" alt="logo" width=250 height=110 />
      <p>Bienvenido a Equipos Bachoco! <br /> Inicia con tus credenciales:</p>
      <div class="floating-label">
        <input placeholder="Email" type="email" name="correo" id="email" autocomplete="off">
  ...
  <?php require_once('../../../componentes/footerB.php');?>